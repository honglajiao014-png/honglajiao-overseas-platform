            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm sticky top-24">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-bold border-2 border-green-500 text-green-600 bg-white">
                    ...
                    <span className="select-all">+1 (310) 290-1842</span>
                    <button onClick={(e) => { e.preventDefault(); navigator.clipboard.writeText("+1 (310) 290-1842"); alert("Copied!"); }} className="px-2 py-0.5 text-xs bg-green-500 text-white rounded-lg hover:bg-green-600">Copy</button>
                  </div>
                </div>
              </div>
            </div>
