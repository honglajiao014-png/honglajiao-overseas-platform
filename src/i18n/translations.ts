...
export const T = {
  ...
  header: {
    ...
    submitRequest: E("Submit Request", "Soumettre une demande", "Enviar solicitud", "提交需求"),
    blog: E("Blog", "Blog", "Blog", "博客"),
    login: E("Login", "Connexion", "Iniciar sesión", "登录"),
    register: E("Register", "S'inscrire", "Registrarse", "注册"),
    language: E("Language", "Langue", "Idioma", "语言"),
  },
