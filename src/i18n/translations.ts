...
const E = (en: string, fr = en, es = en, zh = en, ar = en, sw = en, pt = en) => ({ en, fr, es, zh, ar, sw, pt });

export const T = {
  site: {
    name: E("Honglajiao Auto Export", "Honglajiao Auto Export", "Honglajiao Auto Export", "红辣椒汽车出口", "هونجلاجياو لتصدير السيارات", "Honglajiao Usafirishaji Magari", "Honglajiao Exportação de Veículos"),
    tagline: E("China Used Cars, EVs & Commercial Vehicles Export to Africa", "Exportation de voitures d'occasion, VE et véhicules utilitaires de Chine vers l'Afrique", "Exportación de autos usados, VE y vehículos comerciales de China a África", "中国二手车、电动车及商用车出口非洲", "تصدير السيارات المستعملة والمركبات الكهربائية والمركبات التجارية من الصين إلى أفريقيا", "Usafirishaji wa Magari, EVs na Magari ya Biashara kutoka China kwenda Afrika", "Exportação de Carros Usados, VEs e Veículos Comerciais da China para África"),
    description: E("Your trusted partner for sourcing verified used cars, EVs, trucks and construction machinery from China to African left-hand-drive markets.", "Votre partenaire de confiance pour l'approvisionnement de voitures d'occasion vérifiées, VE, camions et engins de Chine vers les marchés africains LHD.", "Su socio de confianza para el abastecimiento de autos usados, VE, camiones y maquinaria de China a mercados LHD africanos.", "从中国采购经过验证的二手车、电动车、卡车和工程机械，出口至非洲左舵市场。", "شريكك الموثوق لتوريد السيارات المستعملة والمركبات الكهربائية والشاحنات وآلات البناء الموثقة من الصين إلى الأسواق الأفريقية ذات المقود الأيسر.", "Mshirika wako wa kuaminika kwa kutafuta magari yaliyothibitishwa, EVs, malori na mashine za ujenzi kutoka China kwenda masoko ya Afrika ya LHD.", "Seu parceiro de confiança para fornecimento de carros usados, VEs, caminhões e máquinas de construção verificados da China para mercados africanos LHD."),
    copyright: E("Copyright 2026 Honglajiao Auto Export All Rights Reserved", "Copyright 2026 Honglajiao Auto Export Tous droits réservés", "Copyright 2026 Honglajiao Auto Export Todos los derechos reservados", "Copyright 2026 红辣椒汽车出口 版权所有", "© 2026 هونجلاجياو لتصدير السيارات جميع الحقوق محفوظة", "© 2026 Honglajiao Usafirishaji Magari Haki Zote Zimehifadhiwa", "© 2026 Honglajiao Exportação de Veículos Todos os Direitos Reservados"),
    footerTag: E("Honglajiao Auto Export | China Used Car & Vehicle Export Sourcing", "Honglajiao Auto Export | Approvisionnement export de voitures et véhicules de Chine", "Honglajiao Auto Export | Abastecimiento de autos y vehículos de China", "红辣椒汽车出口 | 中国二手车及车辆出口采购", "هونجلاجياو لتصدير السيارات | توريد السيارات المستعملة والمركبات من الصين", "Honglajiao Usafirishaji Magari | Utumaji Magari na Magari Kutoka China", "Honglajiao Exportação de Veículos | Fornecimento de Exportação de Carros e Veículos da China"),
  },
  nav: {
    home: E("Home", "Accueil", "Inicio", "首页", "الرئيسية", "Nyumbani", "Início"),
    vehicles: E("Vehicles", "Véhicules", "Vehículos", "车辆", "المركبات", "Magari", "Veículos"),
    machinery: E("Machinery", "Machines", "Maquinaria", "工程机械", "الآلات", "Mashine", "Máquinas"),
    inquiry: E("Inquiry", "Demande", "Consulta", "询价", "استفسار", "Uchunguzi", "Consulta"),
    services: E("Services", "Services", "Servicios", "服务", "الخدمات", "Huduma", "Serviços"),
    about: E("About", "À propos", "Acerca de", "关于我们", "عن الشركة", "Kuhusu", "Sobre"),
    contact: E("Contact", "Contact", "Contacto", "联系我们", "اتصل بنا", "Wasiliana", "Contato"),
    autoExport: E("Auto Export", "Export Auto", "Exportación Auto", "汽车出口", "تصدير السيارات", "Usafirishaji Magari", "Exportação de Veículos"),
    china: E("China", "Chine", "China", "中国", "الصين", "China", "China"),
  },
  hero: {
    badge: E("Trusted by buyers across 30+ African countries", "Approuvé par des acheteurs dans plus de 30 pays africains", "Confiado por compradores en más de 30 países africanos", "来自30多个非洲国家买家的信赖", "موثوق من قبل المشترين في أكثر من 30 دولة أفريقية", "Inaaminika na wanunuzi katika nchi zaidi ya 30 za Afrika", "Confiável por compradores em mais de 30 países africanos"),
    title: E("Source Used Cars, Commercial Vehicles & Machinery from China", "Approvisionnement en voitures d'occasion, véhicules utilitaires et engins de Chine", "Abastecimiento de autos usados, vehículos comerciales y maquinaria de China", "从中国采购二手车、商用车和工程机械", "توريد السيارات المستعملة والمركبات التجارية والآلات من الصين", "Tafuta Magari Yaliyotumika, Magari ya Biashara na Mashine kutoka China", "Fornecimento de Carros Usados, Veículos Comerciais e Máquinas da China"),
    subtitle: E("We help African buyers source verified used cars, commercial vehicles, EVs, and construction machinery from China", "Nous aidons les acheteurs africains à s'approvisionner en voitures d'occasion, véhicules utilitaires, VE et engins de chantier de Chine", "Ayudamos a compradores africanos a abastecerse de autos usados, vehículos comerciales, VE y maquinaria de construcción de China", "帮助非洲买家从中国采购经过验证的二手车、商用车、电动车和工程机械", "نساعد المشترين الأفارقة في توريد السيارات المستعملة والمركبات التجارية والمركبات الكهربائية وآلات البناء الموثقة من الصين", "Tunasaidia wanunuzi wa Afrika kutafuta magari yaliyothibitishwa, magari ya biashara, EVs na mashine za ujenzi kutoka China", "Ajudamos compradores africanos a fornecer carros usados, veículos comerciais, VEs e máquinas de construção verificados da China"),
    promise: E("Real photos + video inspection + full export support — before you pay", "Photos réelles + inspection vidéo + support export complet — avant de payer", "Fotos reales + inspección por video + soporte completo de exportación — antes de pagar", "真实照片 + 视频验车 + 全程出口服务 — 先验货后付款", "صور حقيقية + فحص بالفيديو + دعم تصدير كامل — قبل أن تدفع", "Picha halisi + ukaguzi wa video + msaada kamili wa usafirishaji — kabla ya kulipa", "Fotos reais + inspeção por vídeo + suporte completo de exportação — antes de pagar"),
    submitBtn: E("Submit Inquiry", "Soumettre une demande", "Enviar consulta", "提交询价", "تقديم استفسار", "Tuma Uchunguzi", "Enviar Consulta"),
    browseBtn: E("Browse Vehicles", "Voir les véhicules", "Explorar vehículos", "浏览车辆", "تصفح المركبات", "Vinjari Magari", "Explorar Veículos"),
    howBtn: E("How It Works", "Comment ça marche", "Cómo funciona", "采购流程", "كيف يعمل", "Jinsi Inavyofanya", "Como Funciona"),
    trust1: E("259-Point Inspection", "Inspection en 259 points", "Inspección de 259 puntos", "259项检测", "فحص 259 نقطة", "Ukaguzi wa Vipengele 259", "Inspeção de 259 Pontos"),
    trust2: E("Real Photo & Video Inspection", "Inspection réelle photo et vidéo", "Inspección real con fotos y video", "真实照片和视频检测", "فحص بالصور والفيديو الحقيقي", "Ukaguzi wa Picha na Video Halisi", "Inspeção Real com Fotos e Vídeo"),
    trust3: E("Full Export Service", "Service export complet", "Servicio completo de exportación", "完整出口服务", "خدمة تصدير كاملة", "Huduma Kamili ya Usafirishaji", "Serviço Completo de Exportação"),
    trust4: E("EN/FR/ZH Trilingual", "Trilingue EN/FR/ZH", "Trilingüe EN/FR/ZH", "中英法三语服务", "خدمة بثلاث لغات", "Huduma ya Lugha Tatu", "Serviço Trilíngue"),
  },
  services: {
    subheading: E("Sourcing Services", "Services d'approvisionnement", "Servicios de abastecimiento", "采购服务", "خدمات التوريد", "Huduma za Utumaji", "Serviços de Fornecimento"),
    heading: E("What We Source", "Ce que nous approvisionnons", "Lo que abastecemos", "我们的采购范围", "ما نقوم بتوريده", "Tunachotafuta", "O que Fornecemos"),
    s1_title: E("Passenger Cars", "Voitures particulières", "Autos de pasajeros", "乘用车", "سيارات الركاب", "Magari ya Abiria", "Carros de Passageiros"),
  ...
  process: {
    heading: E("Our Sourcing Process", "Notre processus d'approvisionnement", "Nuestro proceso de abastecimiento", "采购流程", "عملية التوريد لدينا", "Mchakato Wetu wa Utumaji", "Nosso Processo de Fornecimento"),
    subheading: E("How we source and deliver", "Comment nous approvisionnons et livrons", "Cómo abastecemos y entregamos", "采购和交付流程", "كيف نقوم بالتوريد والتسليم", "Jinsi tunavyotafuta na kuwasilisha", "Como fornecemos e entregamos"),
    p1_title: E("Submit Your Requirements", "Soumettez vos besoins", "Envíe sus requisitos", "提交需求", "قدم متطلباتك", "Tuma Mahitaji Yako", "Envie Seus Requisitos"),
    ...
    p2_title: E("Supplier Matching", "Recherche de fournisseurs", "Búsqueda de proveedores", "供应商匹配", "مطابقة الموردين", "Ulinganishaji wa Wasambazaji", "Correspondência de Fornecedores"),
    ...
    p3_title: E("Inspection & Quotation", "Inspection et devis", "Inspección y cotización", "检测与报价", "الفحص والتسعير", "Ukaguzi na Bei", "Inspeção e Cotação"),
    ...
    p4_title: E("Contract & Documentation", "Contrat et documentation", "Contrato y documentación", "合同与单证", "العقد والتوثيق", "Mkataba na Nyaraka", "Contrato e Documentação"),
    ...
    p5_title: E("Payment & Logistics", "Paiement et logistique", "Pago y logística", "付款与物流", "الدفع والخدمات اللوجستية", "Malipo na Usafirishaji", "Pagamento e Logística"),
  ...
  vehicles: {
    verified: E("Verified Vehicles", "Véhicules vérifiés", "Vehículos verificados", "已验证车辆", "مركبات موثقة", "Magari Yaliyothibitishwa", "Veículos Verificados"),
    browse: E("Browse Vehicle Listings", "Parcourir les annonces", "Explorar anuncios de vehículos", "浏览车源", "تصفح قوائم المركبات", "Vinjari Orodha ya Magari", "Explorar Listagens de Veículos"),
    comingSoon: E("Verified Vehicles Coming Soon", "Véhicules vérifiés bientôt disponibles", "Vehículos verificados próximamente", "已验证车辆即将上线", "المركبات الموثقة قريباً", "Magari Yaliyothibitishwa Yanakuja Hivi Karibuni", "Veículos Verificados em Breve"),
    comingDesc: E("No verified vehicles are currently available. Listings will appear here after photo masking, on-site inspection, and supplier confirmation.", "Aucun véhicule vérifié n'est actuellement disponible. Les annonces apparaîtront après masquage des photos, inspection sur site et confirmation du fournisseur.", "No hay vehículos verificados disponibles. Los anuncios aparecerán después del enmascaramiento de fotos, inspección y confirmación.", "暂无已验证车源。照片打码、实车检测、供应商确认后车源将自动上架展示。", "لا توجد مركبات موثقة متاحة حالياً. ستظهر القوائم هنا بعد إخفاء الصور والفحص الميداني وتأكيد المورد.", "Hakuna magari yaliyothibitishwa yanayopatikana kwa sasa. Orodha itaonekana hapa baada ya kuchuja picha, ukaguzi wa tovuti na uthibitisho wa msambazaji.", "Nenhum veículo verificado disponível no momento. As listagens aparecerão aqui após mascaramento de fotos, inspeção no local e confirmação do fornecedor."),
    cantFind: E("Can't find what you need? Submit an inquiry", "Vous ne trouvez pas? Soumettez une demande", "¿No encuentra lo que busca? Envíe una consulta", "没有找到想要的？提交采购需求", "لم تجد ما تحتاجه؟ قدم استفساراً", "Haujapata unachohitaji? Tuma uchunguzi", "Não encontrou o que precisa? Envie uma consulta"),
    priceLabel: E("Price Indication", "Indication de prix", "Indicación de precio", "参考价格", "السعر التقريبي", "Bei ya Makadirio", "Indicação de Preço"),
    manual: E("Manual", "Manuelle", "Manual", "手动", "يدوي", "Mwongozo", "Manual"),
    automatic: E("Automatic", "Automatique", "Automático", "自动", "أوتوماتيك", "Otomatiki", "Automático"),
    viewAll: E("View All Vehicles", "Voir tous les véhicules", "Ver todos los vehículos", "查看全部车辆", "عرض جميع المركبات", "Tazama Magari Yote", "Ver Todos os Veículos"),
    viewDetail: E("View Details", "Voir les détails", "Ver detalles", "查看详情", "عرض التفاصيل", "Tazama Maelezo", "Ver Detalhes"),
    allBrands: E("All Brands", "Toutes les marques", "Todas las marcas", "全部品牌", "جميع العلامات التجارية", "Chapa Zote", "Todas as Marcas"),
    allTypes: E("All Types", "Tous les types", "Todos los tipos", "全部类型", "جميع الأنواع", "Aina Zote", "Todos os Tipos"),
  ...
  inquiry: {
    ...
    name: E("Your Name", "Votre nom", "Su nombre", "姓名", "اسمك", "Jina Lako", "Seu Nome"),
    ...
    email: E("Your Email", "Votre email", "Su email", "邮箱", "بريدك الإلكتروني", "Barua Pepe Yako", "Seu Email"),
    ...
    vehicleType: E("Vehicle Type", "Type de véhicule", "Tipo de vehículo", "车辆类型", "نوع المركبة", "Aina ya Gari", "Tipo de Veículo"),
    ...
    submit: E("Submit Inquiry", "Soumettre une demande", "Enviar consulta", "提交询价", "تقديم استفسار", "Tuma Uchunguzi", "Enviar Consulta"),
    sending: E("Sending...", "Envoi en cours...", "Enviando...", "发送中...", "جار الإرسال...", "Inatumwa...", "Enviando..."),
  ...
  vehicleTypes: {
    ...
    passenger: E("Used Passenger Car", "Voiture particulière d'occasion", "Auto de pasajeros usado", "二手乘用车", "سيارة ركاب مستعملة", "Gari la Abiria Liliyotumika", "Carro de Passageiro Usado"),
    ...
    ev: E("New Energy Vehicle", "Véhicule à énergie nouvelle", "Vehículo de nueva energía", "新能源车", "مركبة طاقة جديدة", "Gari la Nishati Mpya", "Veículo de Nova Energia"),
    motorcycle: E("Motorcycle", "Moto", "Motocicleta", "摩托车", "دراجة نارية", "Pikipiki", "Motocicleta"),
    parts: E("Auto Parts", "Pièces automobiles", "Repuestos automotrices", "汽车配件", "قطع غيار السيارات", "Vipuri vya Magari", "Peças Automotivas"),
  ...
  machinery: {
    ...
    tonnage: E("Tonnage", "Tonnage", "Tonelaje", "吨位", "الوزن بالطن", "Tani", "Tonelagem"),
    engine: E("Engine", "Moteur", "Motor", "发动机", "المحرك", "Injini", "Motor"),
  ...
  misc: {
    ...
    noResults: E("No results found", "Aucun résultat trouvé", "Sin resultados", "没有找到结果", "لا توجد نتائج", "Hakuna matokeo", "Nenhum resultado encontrado"),
    ...
    step2: E("Supplier Matching", "Recherche de fournisseurs", "Búsqueda de proveedores", "供应商匹配", "مطابقة الموردين", "Ulinganishaji wa Wasambazaji", "Correspondência de Fornecedores"),
  ...
  admin: {
    ...
    loading: E("Loading...", "Chargement...", "Cargando...", "加载中...", "جار التحميل...", "Inapakia...", "Carregando..."),
    ...
    whatsapp: E("WhatsApp", "WhatsApp", "WhatsApp", "WhatsApp", "واتساب", "WhatsApp", "WhatsApp"),
  ...
  homeVehicles: {
    ...
    viewDetails: E("View Details", "Voir les détails", "Ver detalles", "查看详情", "عرض التفاصيل", "Tazama Maelezo", "Ver Detalhes"),
  },

  homeProcess: {
    badge: E("How It Works", "Comment ça marche", "Cómo funciona", "采购流程", "كيف يعمل", "Jinsi Inavyofanya", "Como Funciona"),
  ...
  footer: {
    ...
    company: E("Company", "Entreprise", "Empresa", "公司", "الشركة", "Kampuni", "Empresa"),
  ...
  resources: {
    ...
    verifiedVehicles: E("Verified Vehicles", "Véhicules vérifiés", "Vehículos verificados", "已验证车辆", "مركبات موثقة", "Magari Yaliyothibitishwa", "Veículos Verificados"),
  ...
  cars: {
    ...
    transmission: E("Transmission", "Transmission", "Transmisión", "变速箱", "ناقل الحركة", "Gia", "Transmissão"),
    fuel: E("Fuel", "Carburant", "Combustible", "燃料", "الوقود", "Mafuta", "Combustível"),
    ...
    search: E("Search vehicles...", "Rechercher...", "Buscar...", "搜索车辆...", "البحث عن مركبات...", "Tafuta magari...", "Buscar veículos..."),
    noResults: E("No vehicles match your filters.", "Aucun véhicule ne correspond.", "Ningún vehículo coincide.", "没有匹配的车辆。", "", "", ""),
    results: E("results", "résultats", "resultados", "条结果", "نتائج", "matokeo", "resultados"),
    price: E("Price", "Prix", "Precio", "价格", "السعر", "Bei", "Preço"),
    viewDetails: E("View Details", "Voir détails", "Ver detalles", "查看详情", "عرض التفاصيل", "Tazama Maelezo", "Ver Detalhes"),
    allBrands: E("All Brands", "Toutes marques", "Todas marcas", "全部品牌", "جميع العلامات التجارية", "Chapa Zote", "Todas as Marcas"),
    allTypes: E("All Types", "Tous types", "Todos tipos", "全部类型", "جميع الأنواع", "Aina Zote", "Todos os Tipos"),
  ...
  // Services page
  servicesPage: {
    heading: E("Our Services", "Nos services", "Nuestros servicios", "我们的服务", "خدماتنا", "Huduma Zetu", "Nossos Serviços"),
    ...
    inspection: E("259-Point Inspection", "Inspection 259 points", "Inspección de 259 puntos", "259项检测", "فحص 259 نقطة", "Ukaguzi wa Vipengele 259", "Inspeção de 259 Pontos"),
  ...
  contact: {
    ...
    email: E("Email", "E-mail", "Correo electrónico", "邮箱", "البريد الإلكتروني", "Barua Pepe", "Email"),
    wechat: E("WeChat", "WeChat", "WeChat", "微信", "وي شات", "WeChat", "WeChat"),
    whatsapp: E("WhatsApp", "WhatsApp", "WhatsApp", "WhatsApp", "واتساب", "WhatsApp", "WhatsApp"),
    ...
    name: E("Name", "Nom", "Nombre", "姓名", "الاسم", "Jina", "Nome"),
    yourEmail: E("Your Email", "Votre e-mail", "Su correo", "您的邮箱", "بريدك الإلكتروني", "Barua Pepe Yako", "Seu Email"),
    message: E("Message", "Message", "Mensaje", "留言", "", "", ""),
    send: E("Send Message", "Envoyer", "Enviar", "发送", "إرسال الرسالة", "Tuma Ujumbe", "Enviar Mensagem"),
  ...
  loginPage: {
    ...
    emailLabel: E("Email", "E-mail", "Correo electrónico", "邮箱", "البريد الإلكتروني", "Barua Pepe", "Email"),
    passwordLabel: E("Password", "Mot de passe", "Contraseña", "密码", "كلمة المرور", "Nenosiri", "Senha"),
    loginBtn: E("Login", "Connexion", "Iniciar sesión", "登录", "", "", ""),
    noAccount: E("Don't have an account?", "Pas de compte ?", "¿No tiene cuenta?", "还没有账号？", "ليس لديك حساب؟", "Huna akaunti?", "Não tem uma conta?"),
  ...
  registerPage: {
    ...
    googleBtn: E("Continue with Google", "Continuer avec Google", "Continuar con Google", "继续使用Google账号", "", "", ""),
    hasAccount: E("Already have an account?", "Déjà un compte ?", "¿Ya tiene cuenta?", "已有账号？", "لديك حساب بالفعل؟", "Tayari una akaunti?", "Já tem uma conta?"),
  ...
  chat: {
    ...
    chat: E("Chat", "Chat", "Chat", "聊天", "", "", ""),
    whatsapp: E("WhatsApp", "WhatsApp", "WhatsApp", "WhatsApp", "واتساب", "WhatsApp", "WhatsApp"),
    email: E("Email", "E-mail", "Correo", "邮箱", "البريد الإلكتروني", "Barua Pepe", "Email"),
  ...
  homeFilter: {
    ...
    results: E("results", "résultats", "resultados", "辆车源", "نتائج", "matokeo", "resultados"),
    foundTotal: E("Found", "Trouvé", "Encontrado", "共找到", "", "", ""),
    sort: E("Sort", "Trier", "Ordenar", "排序", "", "", ""),
    viewAll: E("View All Vehicles", "Voir tous", "Ver todos", "查看全部车源", "عرض جميع المركبات", "Tazama Magari Yote", "Ver Todos os Veículos"),
    ...
    breadcrumbHome: E("Home", "Accueil", "Inicio", "首页", "الرئيسية", "Nyumbani", "Início"),
    breadcrumbCars: E("All Vehicles", "Tous véhicules", "Todos vehículos", "全部车源", "", "", ""),

    // Filter values (translated)
    priceAll: E("Any", "Tout", "Cualquier", "不限", "", "", ""),
    priceUnder3: E("Under ¥30,000", "Moins de ¥30,000", "Menos de ¥30,000", "3万以下", "", "", ""),
    price3to5: E("¥30-50k", "¥30-50k", "¥30-50k", "3-5万", "", "", ""),
    price5to10: E("¥50-100k", "¥50-100k", "¥50-100k", "5-10万", "", "", ""),
    price10to15: E("¥100-150k", "¥100-150k", "¥100-150k", "10-15万", "", "", ""),
    price15to20: E("¥150-200k", "¥150-200k", "¥150-200k", "15-20万", "", "", ""),
    priceOver20: E("¥200k+", "¥200k+", "¥200k+", "20万以上", "", "", ""),
    priceUnit: E("10k", "10k", "10k", "万", "", "", ""),
    priceMin: E("Min", "Min", "Mín", "最低", "", "", ""),
    priceMax: E("Max", "Max", "Máx", "最高", "", "", ""),
    levelSedan: E("Sedan", "Berline", "Sedán", "轿车", "", "", ""),
    levelSUV: E("SUV", "SUV", "SUV", "SUV", "", "", ""),
    levelMPV: E("MPV", "MPV", "MPV", "MPV", "", "", ""),
    levelSports: E("Sports", "Sport", "Deportivo", "跑车", "", "", ""),
    levelPickup: E("Pickup", "Pick-up", "Camioneta", "皮卡", "", "", ""),
    levelSedan3: E("3-Box Sedan", "Berline 3 volumes", "Sedán 3 volúmenes", "三厢车", "", "", ""),
    levelHatchback: E("Hatchback", "Hayon", "Hatchback", "两厢车", "", "", ""),
    levelWagon: E("Wagon", "Break", "Familiar", "旅行车", "", "", ""),
    levelBus: E("Bus", "Bus", "Autobús", "客车", "", "", ""),
    levelTruck: E("Truck", "Camion", "Camión", "货车", "شاحنة", "Lori", "Caminhão"),
    ageAll: E("不限", "不限", "不限", "不限", "", "", ""),
    ageWithin1: E("1年内", "1年内", "1年内", "1年内", "", "", ""),
    age1to3: E("1-3年", "1-3年", "1-3年", "1-3年", "", "", ""),
    age3to5: E("3-5年", "3-5年", "3-5年", "3-5年", "", "", ""),
    age5to8: E("5-8年", "5-8年", "5-8年", "5-8年", "", "", ""),
    ageOver8: E("8年以上", "8年以上", "8年以上", "8年以上", "", "", ""),
    sortDefault: E("Default", "Défaut", "Predeterminado", "默认排序", "", "", ""),
    sortNewest: E("Newest", "Plus récent", "Más nuevo", "最新上架", "", "", ""),
    sortBest: E("Best Condition", "Meilleur état", "Mejor estado", "成色最好", "", "", ""),
    sortPriceAsc: E("Price Low-High", "Prix croissant", "Precio ascendente", "价格从低到高", "", "", ""),
    sortPriceDesc: E("Price High-Low", "Prix décroissant", "Precio descendente", "价格从高到低", "", "", ""),
    sortYearDesc: E("Newest Year", "Année récente", "Año reciente", "车龄从新到旧", "", "", ""),
    sortMileageAsc: E("Lowest Mileage", "Moins kilométré", "Menos km", "里程从少到多", "", "", ""),
    tagVerified: E("Verified", "Vérifié", "Verificado", "实拍车源", "", "", ""),
    tagChinaStock: E("China Stock", "Stock Chine", "Stock China", "中国车源", "", "", ""),
    yearSuffix: E("年", "年", "年", "年", "", "", ""),
  ...
  carsFilter: {
    ...
    allBrands: E("All Brands", "Toutes marques", "Todas marcas", "不限品牌", "جميع العلامات التجارية", "Chapa Zote", "Todas as Marcas"),
    price: E("Price (10k RMB)", "Prix (10k RMB)", "Precio (10k RMB)", "价格（万元）", "", "", ""),
    age: E("Vehicle Age", "Âge du véhicule", "Edad del vehículo", "车龄", "", "", ""),
    mileage: E("Mileage", "Kilométrage", "Kilometraje", "里程", "المسافة المقطوعة", "Umbali", "Quilometragem"),
    transmission: E("Transmission", "Transmission", "Transmisión", "变速箱", "ناقل الحركة", "Gia", "Transmissão"),
  ...
  inquiryPage: {
    ...
    country: E("Country/Region", "Pays/Région", "País/Región", "国家/地区", "", "", ""),
    email: E("Email", "E-mail", "Correo electrónico", "电子邮箱", "البريد الإلكتروني", "Barua Pepe", "Email"),
    phone: E("Phone Number", "Téléphone", "Teléfono", "手机号", "رقم الهاتف", "Nambari ya Simu", "Número de Telefone"),
    whatsapp: E("WhatsApp", "WhatsApp", "WhatsApp", "WhatsApp", "واتساب", "WhatsApp", "WhatsApp"),
  ...
  accountPage: {
    title: E("Account Settings", "Paramètres du compte", "Configuración de la cuenta", "账号设置", "", "", ""),
    profile: E("Profile", "Profil", "Perfil", "个人信息", "الملف الشخصي", "Wasifu", "Perfil"),
    avatar: E("Avatar", "Avatar", "Avatar", "头像", "", "", ""),
    password: E("Password", "Mot de passe", "Contraseña", "密码", "كلمة المرور", "Nenosiri", "Senha"),
    profileSettings: E("Profile Settings", "Paramètres du profil", "Configuración del perfil", "个人信息设置", "", "", ""),
    avatarSettings: E("Avatar Settings", "Paramètres de l'avatar", "Configuración del avatar", "头像设置", "", "", ""),
    passwordSettings: E("Change Password", "Changer le mot de passe", "Cambiar contraseña", "修改密码", "تغيير كلمة المرور", "Badilisha Nenosiri", "Alterar Senha"),
    name: E("Name", "Nom", "Nombre", "姓名", "الاسم", "Jina", "Nome"),
    email: E("Email", "Email", "Email", "邮箱", "البريد الإلكتروني", "Barua Pepe", "Email"),
    phone: E("Phone", "Téléphone", "Teléfono", "电话", "", "", ""),
    company: E("Company", "Société", "Empresa", "公司", "الشركة", "Kampuni", "Empresa"),
    country: E("Country", "Pays", "País", "国家", "البلد", "Nchi", "País"),
    save: E("Save Changes", "Enregistrer", "Guardar cambios", "保存修改", "حفظ التغييرات", "Hifadhi Mabadiliko", "Salvar Alterações"),
    saved: E("Profile updated!", "Profil mis à jour !", "¡Perfil actualizado!", "个人信息已更新！", "تم تحديث الملف الشخصي!", "Wasifu umesasishwa!", "Perfil atualizado!"),
    chooseImage: E("Choose Image", "Choisir une image", "Elegir imagen", "选择图片", "اختر صورة", "Chagua Picha", "Escolher Imagem"),
    imageHint: E("Supported: JPG, PNG, GIF. Max 5MB.", "Formats: JPG, PNG, GIF. Max 5 Mo.", "Formatos: JPG, PNG, GIF. Máx 5 MB.", "支持 JPG、PNG、GIF 格式，最大 5MB。", "يدعم: JPG، PNG، GIF. الحد الأقصى 5 ميجابايت.", "Inaauni: JPG, PNG, GIF. Max 5MB.", "Suportado: JPG, PNG, GIF. Máx 5MB."),
    upload: E("Upload Avatar", "Télécharger l'avatar", "Subir avatar", "上传头像", "رفع الصورة الرمزية", "Pakia Picha", "Enviar Avatar"),
    avatarUpdated: E("Avatar updated!", "Avatar mis à jour !", "¡Avatar actualizado!", "头像已更新！", "تم تحديث الصورة الرمزية!", "Picha imesasishwa!", "Avatar atualizado!"),
    currentPassword: E("Current Password", "Mot de passe actuel", "Contraseña actual", "当前密码", "كلمة المرور الحالية", "Nenosiri la Sasa", "Senha Atual"),
    newPassword: E("New Password", "Nouveau mot de passe", "Nueva contraseña", "新密码", "كلمة المرور الجديدة", "Nenosiri Jipya", "Nova Senha"),
    confirmPassword: E("Confirm New Password", "Confirmer le nouveau mot de passe", "Confirmar nueva contraseña", "确认新密码", "تأكيد كلمة المرور الجديدة", "Thibitisha Nenosiri Jipya", "Confirmar Nova Senha"),
    changePassword: E("Change Password", "Changer le mot de passe", "Cambiar contraseña", "修改密码", "تغيير كلمة المرور", "Badilisha Nenosiri", "Alterar Senha"),
    passwordChanged: E("Password changed!", "Mot de passe changé !", "¡Contraseña cambiada!", "密码已修改！", "تم تغيير كلمة المرور!", "Nenosiri limebadilishwa!", "Senha alterada!"),
    passwordsNoMatch: E("Passwords don't match", "Les mots de passe ne correspondent pas", "Las contraseñas no coinciden", "两次密码不一致", "كلمتا المرور غير متطابقتين", "Nyenosiri hazilingani", "As senhas não coincidem"),
    switchAccount: E("Switch Account", "Changer de compte", "Cambiar de cuenta", "切换账号", "تبديل الحساب", "Badilisha Akaunti", "Trocar Conta"),
    logout: E("Logout", "Déconnexion", "Cerrar sesión", "退出登录", "تسجيل الخروج", "Toka", "Sair"),
    pleaseLogin: E("Please Log In", "Veuillez vous connecter", "Inicie sesión", "请登录", "يرجى تسجيل الدخول", "Tafadhali Ingia", "Por Favor, Faça Login"),
    pleaseLoginDesc: E("Log in to access your account settings.", "Connectez-vous pour accéder à vos paramètres.", "Inicie sesión para acceder a la configuración.", "登录后即可访问账号设置。", "سجل الدخول للوصول إلى إعدادات حسابك.", "Ingia ili kufikia mipangilio ya akaunti yako.", "Faça login para acessar as configurações da sua conta."),
    loginBtn: E("Log In", "Connexion", "Iniciar sesión", "登录", "تسجيل الدخول", "Ingia", "Entrar"),
    updateError: E("Update failed", "Échec de la mise à jour", "Error de actualización", "更新失败", "فشل التحديث", "Usasishaji umeshindwa", "Falha na atualização"),
    passwordError: E("Change failed", "Échec du changement", "Error de cambio", "修改失败", "فشل التغيير", "Mabadiliko yameshindwa", "Falha na alteração"),
    currentPwdIncorrect: E("Current password is incorrect", "Le mot de passe actuel est incorrect", "La contraseña actual es incorrecta", "当前密码错误", "كلمة المرور الحالية غير صحيحة", "Nenosiri la sasa si sahihi", "Senha atual incorreta"),
    loading: E("Loading...", "Chargement...", "Cargando...", "加载中...", "جار التحميل...", "Inapakia...", "Carregando..."),
  },
  ...
  details: {
    breadcrumbHome: E("Home", "Accueil", "Inicio", "首页", "الرئيسية", "Nyumbani", "Início"),
    breadcrumbCars: E("Cars", "Véhicules", "Vehículos", "车辆列表", "سيارات", "Magari", "Carros"),
    usedPassengerCar: E("Used Passenger Car", "Voiture d'occasion", "Auto usado", "二手乘用车", "سيارة ركاب مستعملة", "Gari la Abiria Liliyotumika", "Carro de Passageiro Usado"),
    newEnergy: E("New Energy Vehicle", "Véhicule électrique", "Vehículo eléctrico", "新能源车", "مركبة طاقة جديدة", "Gari la Nishati Mpya", "Veículo de Nova Energia"),
    truck: E("Truck", "Camion", "Camión", "卡车", "شاحنة", "Lori", "Caminhão"),
    machinery: E("Construction Machinery", "Engins de chantier", "Maquinaria", "工程机械", "آلات البناء", "Mashine za Ujenzi", "Máquinas de Construção"),
    motorcycle: E("Motorcycle", "Moto", "Motocicleta", "摩托车", "دراجة نارية", "Pikipiki", "Motocicleta"),
    autoParts: E("Auto Parts", "Pièces auto", "Repuestos", "汽车配件", "قطع غيار السيارات", "Vipuri vya Magari", "Peças Automotivas"),
    basePrice: E("Base Price", "Prix de base", "Precio base", "底价", "السعر الأساسي", "Bei ya Msingi", "Preço Base"),
    priceNote: E("* Base vehicle price only. Excludes shipping, insurance & duties.", "* Prix du véhicule de base uniquement. Hors expédition, assurance et droits.", "* Precio base del vehículo solamente. Excluye envío, seguro e impuestos.", "* 仅裸车价格。不含运费、保险和关税。", "* سعر المركبة الأساسي فقط. لا يشمل الشحن والتأمين والرسوم.", "* Bei ya gari la msingi pekee. Haijumuishi usafirishaji, bima na ushuru.", "* Apenas preço base do veículo. Exclui frete, seguro e taxas."),
    inquireNow: E("Inquire Now", "Demander", "Consultar ahora", "立即询价", "استفسر الآن", "Uliza Sasa", "Consultar Agora"),
    contactWhatsApp: E("Contact via WhatsApp", "Contacter via WhatsApp", "Contactar por WhatsApp", "通过WhatsApp联系", "تواصل عبر واتساب", "Wasiliana kupitia WhatsApp", "Contatar via WhatsApp"),
    specYear: E("Year", "Année", "Año", "年份", "السنة", "Mwaka", "Ano"),
    specMileage: E("Mileage", "Kilométrage", "Kilometraje", "里程", "المسافة المقطوعة", "Umbali", "Quilometragem"),
    specTransmission: E("Transmission", "Transmission", "Transmisión", "变速箱", "ناقل الحركة", "Gia", "Transmissão"),
    specFuel: E("Fuel", "Carburant", "Combustible", "燃料", "الوقود", "Mafuta", "Combustível"),
    specSteering: E("Steering", "Direction", "Dirección", "方向盘", "المقود", "Usukani", "Direção"),
    specColor: E("Color", "Couleur", "Color", "颜色", "اللون", "Rangi", "Cor"),
    specDisplacement: E("Displacement", "Cylindrée", "Cilindrada", "排量", "الإزاحة", "Ujazo", "Cilindrada"),
    specBodyStyle: E("Body Style", "Carrosserie", "Carrocería", "车身类型", "نوع الهيكل", "Aina ya Mwili", "Carroceria"),
    specSeats: E("Seats", "Places", "Asientos", "座位", "المقاعد", "Viti", "Assentos"),
    specEngine: E("Engine", "Moteur", "Motor", "发动机", "المحرك", "Injini", "Motor"),
    specRange: E("Range", "Autonomie", "Autonomía", "续航", "المدى", "Masafa", "Autonomia"),
    specBattery: E("Battery", "Batterie", "Batería", "电池", "البطارية", "Betri", "Bateria"),
    specHours: E("Hours", "Heures", "Horas", "工作时长", "ساعات", "Saa", "Horas"),
    specTonnage: E("Tonnage", "Tonnage", "Tonelaje", "吨位", "الوزن بالطن", "Tani", "Tonelagem"),
    specLoad: E("Load", "Charge", "Carga", "载重", "الحمولة", "Mzigo", "Carga"),
    lhd: E("LHD", "Conduite à gauche", "Volante izquierdo", "左舵", "مقود يسار", "LHD", "LHD"),
    rhd: E("RHD", "Conduite à droite", "Volante derecho", "右舵", "مقود يمين", "RHD", "RHD"),
    km: E("km", "km", "km", "公里", "كم", "km", "km"),
    noImage: E("No Image", "Pas d'image", "Sin imagen", "无图片", "لا توجد صورة", "Hakuna Picha", "Sem Imagem"),
  },
};
