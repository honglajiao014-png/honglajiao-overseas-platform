...
export const T = {
  ...
  homeFilter: {
    ...
    levelTruck: E("Truck", "Camion", "Camión", "货车"),
  ...
  accountPage: {
    ...
    profile: E("Profile", "Profil", "Perfil", "个人信息"),
    ...
    passwordSettings: E("Change Password", "Changer le mot de passe", "Cambiar contraseña", "修改密码"),
    name: E("Name", "Nom", "Nombre", "姓名"),
    email: E("Email", "Email", "Email", "邮箱"),
    phone: E("Phone", "Téléphone", "Teléfono", "电话"),
    company: E("Company", "Société", "Empresa", "公司"),
    country: E("Country", "Pays", "País", "国家"),
    save: E("Save Changes", "Enregistrer", "Guardar cambios", "保存修改"),
    saved: E("Profile updated!", "Profil mis à jour !", "¡Perfil actualizado!", "个人信息已更新！"),
    chooseImage: E("Choose Image", "Choisir une image", "Elegir imagen", "选择图片"),
    imageHint: E("Supported: JPG, PNG, GIF. Max 5MB.", "Formats: JPG, PNG, GIF. Max 5 Mo.", "Formatos: JPG, PNG, GIF. Máx 5 MB.", "支持 JPG、PNG、GIF 格式，最大 5MB。"),
    upload: E("Upload Avatar", "Télécharger l'avatar", "Subir avatar", "上传头像"),
    avatarUpdated: E("Avatar updated!", "Avatar mis à jour !", "¡Avatar actualizado!", "头像已更新！"),
    currentPassword: E("Current Password", "Mot de passe actuel", "Contraseña actual", "当前密码"),
    newPassword: E("New Password", "Nouveau mot de passe", "Nueva contraseña", "新密码"),
    confirmPassword: E("Confirm New Password", "Confirmer le nouveau mot de passe", "Confirmar nueva contraseña", "确认新密码"),
    changePassword: E("Change Password", "Changer le mot de passe", "Cambiar contraseña", "修改密码"),
    passwordChanged: E("Password changed!", "Mot de passe changé !", "¡Contraseña cambiada!", "密码已修改！"),
    passwordsNoMatch: E("Passwords don't match", "Les mots de passe ne correspondent pas", "Las contraseñas no coinciden", "两次密码不一致"),
    switchAccount: E("Switch Account", "Changer de compte", "Cambiar de cuenta", "切换账号"),
    logout: E("Logout", "Déconnexion", "Cerrar sesión", "退出登录"),
    pleaseLogin: E("Please Log In", "Veuillez vous connecter", "Inicie sesión", "请登录"),
    pleaseLoginDesc: E("Log in to access your account settings.", "Connectez-vous pour accéder à vos paramètres.", "Inicie sesión para acceder a la configuración.", "登录后即可访问账号设置。"),
    loginBtn: E("Log In", "Connexion", "Iniciar sesión", "登录"),
    updateError: E("Update failed", "Échec de la mise à jour", "Error de actualización", "更新失败"),
  ...
  details: {
    breadcrumbHome: E("Home", "Accueil", "Inicio", "首页"),
    breadcrumbCars: E("Cars", "Véhicules", "Vehículos", "车辆列表"),
    usedPassengerCar: E("Used Passenger Car", "Voiture d'occasion", "Auto usado", "二手乘用车"),
    newEnergy: E("New Energy Vehicle", "Véhicule électrique", "Vehículo eléctrico", "新能源车"),
    truck: E("Truck", "Camion", "Camión", "卡车"),
    machinery: E("Construction Machinery", "Engins de chantier", "Maquinaria", "工程机械"),
    motorcycle: E("Motorcycle", "Moto", "Motocicleta", "摩托车"),
    autoParts: E("Auto Parts", "Pièces auto", "Repuestos", "汽车配件"),
    basePrice: E("Base Price", "Prix de base", "Precio base", "底价"),
    priceNote: E("* Base vehicle price only. Excludes shipping, insurance & duties.", "* Prix du véhicule de base uniquement. Hors expédition, assurance et droits.", "* Precio base del vehículo solamente. Excluye envío, seguro e impuestos.", "* 仅裸车价格。不含运费、保险和关税。"),
    inquireNow: E("Inquire Now", "Demander", "Consultar ahora", "立即询价"),
    contactWhatsApp: E("Contact via WhatsApp", "Contacter via WhatsApp", "Contactar por WhatsApp", "通过WhatsApp联系"),
    specYear: E("Year", "Année", "Año", "年份"),
    specMileage: E("Mileage", "Kilométrage", "Kilometraje", "里程"),
    specTransmission: E("Transmission", "Transmission", "Transmisión", "变速箱"),
    specFuel: E("Fuel", "Carburant", "Combustible", "燃料"),
    specSteering: E("Steering", "Direction", "Dirección", "方向盘"),
    specColor: E("Color", "Couleur", "Color", "颜色"),
    specDisplacement: E("Displacement", "Cylindrée", "Cilindrada", "排量"),
    specBodyStyle: E("Body Style", "Carrosserie", "Carrocería", "车身类型"),
    specSeats: E("Seats", "Places", "Asientos", "座位"),
    specEngine: E("Engine", "Moteur", "Motor", "发动机"),
    specRange: E("Range", "Autonomie", "Autonomía", "续航"),
    specBattery: E("Battery", "Batterie", "Batería", "电池"),
    specHours: E("Hours", "Heures", "Horas", "工作时长"),
    specTonnage: E("Tonnage", "Tonnage", "Tonelaje", "吨位"),
    specLoad: E("Load", "Charge", "Carga", "载重"),
    lhd: E("LHD", "Conduite à gauche", "Volante izquierdo", "左舵"),
    rhd: E("RHD", "Conduite à droite", "Volante derecho", "右舵"),
    km: E("km", "km", "km", "公里"),
    noImage: E("No Image", "Pas d'image", "Sin imagen", "无图片"),
  },
};
